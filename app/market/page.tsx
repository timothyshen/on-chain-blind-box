...
import { ArrowLeft, Store, TrendingUp, Users, Coins } from "lucide-react"
...
export default function Market() {
  ...
  const filteredListings = listings
    .filter((listing) => {
      ...
      return matchesCollection && matchesVersion
    })
    .sort((a, b) => {
      switch (sortBy) {
        case "price":
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg text-slate-600 font-medium mt-1">Buy, Sell & Trade Collections</p>
            </div>
          </div>
              ...
              {filteredListings.map((listing) => (
                <Card
                  ...
                  className={cn(
                    ...
                    COLLECTION_COLORS[listing.item.collection],
                    VERSION_STYLES[listing.item.version],
                    COLLECTION_GLOW[listing.item.collection],
                    listing.item.collection === "space" && "ring-2 ring-indigo-300/50",
                  )}
                >
                  <CardHeader className="pb-3">
                    <div className="text-4xl md:text-5xl text-center mb-3 drop-shadow-sm">{listing.item.emoji}</div>
